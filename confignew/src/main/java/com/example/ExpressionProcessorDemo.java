...
import com.example.util.ExpressionProcessor;
 ...
 * 表达式处理器演示类
 */
public class ExpressionProcessorDemo {
    ...
    public static void main(String[] args) {
        ...
        // 处理表达式
        String processedExpression = ExpressionProcessor.processExpression(expression, filterMap);
